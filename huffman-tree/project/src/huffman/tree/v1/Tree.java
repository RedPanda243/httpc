...
//			System.out.println("Saving "+node);
	...
	public static BackUp_Tree load(File file) throws IOException
	{
		BackUp_Tree tree = new BackUp_Tree();
		tree.root = null;
		tree.NYT = null;
		tree.order.clear();
...
//			System.out.println("Reading "+node);
	...
	private Node giveBirth(int value) {
		...
		seen.put(value, leaf); // Add new value to leaves.
		order.add(0,leaf);
		order.add(0,newNYT);
